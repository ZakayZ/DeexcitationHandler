...
const G4double G4StatMFParameters::fW0 = 16.0 * MeV;
...
const G4double G4StatMFParameters::fCoulomb =
    0.6 * (CLHEP::elm_coupling / fr0) * (1.0 - 1.0 / std::pow(1.0 + fKappaCoulomb, 1. / 3.));

G4StatMFParameters::G4StatMFParameters() {}

G4StatMFParameters::~G4StatMFParameters() {}

G4double G4StatMFParameters::GetKappa() { return fKappa; }

G4double G4StatMFParameters::GetKappaCoulomb() { return fKappaCoulomb; }

G4double G4StatMFParameters::GetEpsilon0() { return fEpsilon0; }

G4double G4StatMFParameters::GetW0() { return fW0; }

G4double G4StatMFParameters::GetE0() { return fE0; }

G4double G4StatMFParameters::GetBeta0() { return fBeta0; }

G4double G4StatMFParameters::GetGamma0() { return fGamma0; }

G4double G4StatMFParameters::GetCriticalTemp() { return fCriticalTemp; }

G4double G4StatMFParameters::Getr0() { return fr0; }

G4double G4StatMFParameters::GetCoulomb() { return fCoulomb; }
