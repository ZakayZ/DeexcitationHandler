...
class G4StatMFMacroMultiplicity {
 public:
  G4StatMFMacroMultiplicity(const G4double anA, const G4double kappa, const G4double temp, const G4double nu,
  ...
  G4double operator()(const G4double mu) { return (theA - this->CalcMeanA(mu)) / theA; }
