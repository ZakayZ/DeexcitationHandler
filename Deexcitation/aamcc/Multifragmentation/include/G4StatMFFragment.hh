...
class G4StatMFFragment {
 public:
  // Constructor
  G4StatMFFragment(G4int anA, G4int aZ) : theA(anA), theZ(aZ), _position(0.0, 0.0, 0.0), _momentum(0.0, 0.0, 0.0) {}
 ...
 public:
  ...
  G4double GetNuclearMass(void) { return G4ParticleTable::GetParticleTable()->GetIonTable()->GetIonMass(theZ, theA); }
