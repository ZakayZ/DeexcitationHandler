...
G4bool G4Li5FermiFragment::operator==(const G4Li5FermiFragment&) const { return false; }

G4bool G4Li5FermiFragment::operator!=(const G4Li5FermiFragment&) const { return true; }
