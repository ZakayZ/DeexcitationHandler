...
G4bool G4B9FermiFragment::operator==(const G4B9FermiFragment&) const { return false; }

G4bool G4B9FermiFragment::operator!=(const G4B9FermiFragment&) const { return true; }
