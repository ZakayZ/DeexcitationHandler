...
G4bool G4Be8FermiFragment::operator==(const G4Be8FermiFragment&) const { return false; }

G4bool G4Be8FermiFragment::operator!=(const G4Be8FermiFragment&) const { return true; }
