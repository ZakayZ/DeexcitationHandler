...
G4bool G4UnstableFermiFragment::operator==(const G4UnstableFermiFragment&) const { return false; }

G4bool G4UnstableFermiFragment::operator!=(const G4UnstableFermiFragment&) const { return true; }
...
#endif
    (*i)->boost(Beta);
    theResult->push_back(new G4Fragment(static_cast<G4int>(AtomNum[n]), static_cast<G4int>(Charges[n]), *(*i)));
