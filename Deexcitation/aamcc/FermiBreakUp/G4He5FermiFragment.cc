...
G4bool G4He5FermiFragment::operator==(const G4He5FermiFragment&) const { return false; }

G4bool G4He5FermiFragment::operator!=(const G4He5FermiFragment&) const { return true; }
