...
G4bool G4StableFermiFragment::operator==(const G4StableFermiFragment&) const { return false; }

G4bool G4StableFermiFragment::operator!=(const G4StableFermiFragment&) const { return true; }
